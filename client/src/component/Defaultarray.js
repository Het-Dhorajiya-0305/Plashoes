...
export default function defaultarray(gender) {
    if (gender === "male") {
        const arr = [
            { id: "13", size:"6UK" , quantity:2, gender: "male", name: "men's navy running", price: 8740, loc: shoes7, description: "A sleek and stylish navy blue running shoe designed for comfort and durability, perfect for both casual joggers and seasoned runners." },
            { id: "14", size:"6UK" , quantity:2, gender: "male", name: "men's green running", price: 7480, loc: shoes8, description: "A lightweight, breathable running shoe with a vibrant green tone, offering great grip and shock absorption." },
            { id: "15", size:"6UK" , quantity:2, gender: "male", name: "men's classic mint", price: 6720, loc: mint_shoes, description: "A fresh take on classic sneaker design, featuring a cool mint colorway and a timeless silhouette for everyday wear." },
            { id: "16", size:"6UK" , quantity:2, gender: "male", name: "men's red running", price: 7478, loc: red_shoes, description: "A bold red running shoe engineered for speed and agility, with cushioned soles for enhanced comfort." },
            { id: "17", size:"6UK" , quantity:2, gender: "male", name: "men's black running", price: 4789, loc: black_shoes, description: "A versatile and minimalist black running shoe, ideal for training sessions and casual wear alike." },
            { id: "18", size:"6UK" , quantity:2, gender: "male", name: "men's earth-tone sneaker", price: 7512, loc: shoes13, description: "A stylish sneaker featuring earthy hues, blending fashion with function for a laid-back yet sophisticated look." },
            { id: "19", size:"6UK" , quantity:2, gender: "male", name: "men's moonstone sneaker", price: 4980, loc: shoes14, description: "Inspired by the elegance of moonstone, this sneaker combines light hues and superior comfort for all-day wear." },
            { id: "20", size:"6UK" , quantity:2, gender: "male", name: "men's classic blue", price: 6218, loc: shoes1, description: "A timeless blue sneaker that offers a balance of durability and flexibility, perfect for daily activities." },
        ];
        return arr;
